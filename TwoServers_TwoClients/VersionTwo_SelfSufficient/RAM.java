        ...
        if (ClientOne.One_ConnectStatus == 0) {
            for (int i = 0; i < serverStatuses.length; i++) {
                if (serverStatuses[i] == 1) {
                    ...
                    isConnected = true;
                    if (index == 0) {
                        statusMsg_ClientOne = "Client One will be connected to the Alpha Server";
                    } else if (index == 1) {
                        statusMsg_ClientOne = "Client One will be connected to the Beta Server";
                    }
                    break;
                } else {
                    zeroChecker++;
                    if (zeroChecker == serverStatuses.length) {
                        statusMsg_ClientOne = "Client One will not connect to a server now";
                    }
                }
            }
        }
        ...
        if (ClientTwo.Two_ConnectStatus == 0) {
            for (int i = 0; i < serverStatuses.length; i++) {
                if (serverStatuses[i] == 1) {
                    ...
                    isConnected = true;
                    if (index == 0) {
                        statusMsg_ClientTwo = "Client Two will be connected to the Alpha Server";
                    } else if (index == 1) {
                        statusMsg_ClientTwo = "Client Two will be connected to the Beta Server";
                    }
                    ...
                    if (zeroChecker == serverStatuses.length) {
                        ...
                        statusMsg_ClientTwo = "Client Two will not connect to a server now";
                    }
                }
            }
        }
